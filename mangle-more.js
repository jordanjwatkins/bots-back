...
const blackList1 = [
  'exports', 'Object', 'defineProperty', 'enumerable', 'undefined', 'Symbol', 'toStringTag', 'Module', 'esModule', 'object', 'create', 'string', 'prototype', 'hasOwnProperty', 'strict', 'window', 'AudioContext', 'webkitAudioContext', 'createOscillator', 'createGain', 'random', 'document', 'createElement', 'innerHTML', 'childNodes', 'constructor', 'canvas', 'context', 'height', 'getContext', 'fillStyle', 'fillRect'
]
...
const mainCanvas = [ 'clickCoords', 'scanlines', 'clearCanvas', 'testRect', 'transform', 'flipX', 'rotateThing', 'drawRect', 'drawThing', 'isClickHit', 'clickAreaDebug', 'makeScanlines', 'drawScanlines', 'opacity']
const exposition = ['destroy', 'attachEvents', 'detachEvents', 'drawText', 'drawBackground', 'drawMayor', 'flicker']
...
const pulser = ['destroy', 'canPulse', 'firePulse', 'updateChargeProgress', 'drawChargeProgress', 'drawCharges', 'moving', 'color', 'chargeProgress', 'chargeSpeed', 'maxChargeCount', 'chargeCount', 'pulsesFiredCount']
...
// 'canvas', 'context', 'boundingRect','constructor',
...
//fs.writeFileSync(`./build/toReplace`, JSON.stringify(toReplace, null, 4), 'UTF-8')
